        ...
        >
          <div className="px-4 grid grid-rows-[5rem_1fr] flex-1">
            ...
            <div class="flex flex-col flex-1">
              ...
              {/* Navigation Options */}
              <div
                className="flex items-center border border-gray-300 rounded-lg bg-white p-4 mb-4">
                <span className="font-bold">
                  Chinese{" "}
                </span>
                <span onClick={() => handleNavigation("#")} className="ml-auto text-blue-500">Switch</span>
              </div>
