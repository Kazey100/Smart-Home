    ...
    <div className="grid grid-rows-[auto_1fr] grid-cols-[auto_1fr] bg-gray-300 h-full w-auto">
      ...
      <div className="w-full mx-auto my-4">
        <div className="flex items-center justify-between px-5">
          <a
            className="text-black font-bold text-4xl no-underline"
            href="#"
            onClick={previous}
          >
            ←
          </a>
          <h2 className="m-0 text-lg">{new Date(currentYear, currentMonth).toLocaleString("default", { month: "long" })} {currentYear}</h2>
          <a
            className="text-black font-bold text-4xl no-underline"
            href="#"
            onClick={next}
        ...
        <div className="flex bg-white p-4 max-w-11/12 mx-auto shadow-lg rounded-md gap-8">
          <div className="min-w-[200px] max-w-[300px] bg-gray-200 rounded-md p-4">
            <div className="my-4">
              ...
              <ul className="list-none p-0">
                {reminders.map((reminder, index) => (
                  <li key={index} className="my-2 text-sm">
                    ...
                    <button
                      className="ml-4 bg-red-600 text-white px-2 py-1 text-xs rounded hover:bg-red-700"
          ...
          <div className="bg-gray-700 w-full h-full p-4 rounded-md">
            <h3 className="text-white text-center">
              {new Date().toLocaleString("default", { month: "long" })} {new Date().getFullYear()}
            </h3>
            <div className="flex justify-between my-4">
              <button onClick={previous} className="bg-green-600 text-white px-3 py-1 rounded">‹</button>
              <button onClick={next} className="bg-green-600 text-white px-3 py-1 rounded">›</button>
            </div>
            ...
            <div className="flex justify-between my-4">
              ...
              <select
                id="month"
                className="cursor-pointer bg-white text-gray-700 border rounded px-3 py-1"
